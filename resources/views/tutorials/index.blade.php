                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex justify-center gap-2">
                            ...
                            <a href="{{ route('tutorial-details.index', $tutorial->id) }}"
                               class="bg-indigo-100 text-indigo-700 hover:bg-indigo-200 text-xs px-3 py-1 rounded font-medium transition">
                                Detail
                            </a>
                            {{-- Edit --}}
                            <a href="{{ route('tutorials.edit', $tutorial->id) }}"
                               class="bg-yellow-100 text-yellow-700 hover:bg-yellow-200 text-xs px-3 py-1 rounded font-medium transition">
                                Edit
                            </a>
                            {{-- Hapus --}}
                            <form method="POST" action="{{ route('tutorials.destroy', $tutorial->id) }}"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                        class="bg-red-100 text-red-700 hover:bg-red-200 text-xs px-3 py-1 rounded font-medium transition">
                                    Hapus
                                </button>
                            </form>
                        </div>
